...
public class EstudanteController {
	...
	public Page<Estudante> buscarEstudantePorPaginacao(@RequestParam(defaultValue = "0") Integer pagina,@RequestParam(defaultValue  = "5") Integer itensPorPagina, @RequestParam(defaultValue = "id") String ordenarPor){
		return estudanteService.buscarEstudantePorPaginacao(PageRequest.of(pagina, itensPorPagina, Sort.by(ordenarPor).ascending()));
	}
}
